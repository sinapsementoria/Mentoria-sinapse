                ...
                extend: {
                    ...
                    colors: {
                        ...
                        sinapse: {
                            ...
                            blue: '#0B193C', // Escuro Institucional

                            primary: '#6366F1', // Indigo Premium

                            accent: '#10B981', // Verde central

                            light: '#FAFAFB', // Fundo Principal Super Clean
                    ...
                    boxShadow: {
                        ...
                        'hyper-card': '12px 16px 20px rgba(184,171,155,0.7), -10px -10px 15px rgba(255,255,255,0.6), inset 1px 1px 2px rgba(255,255,255,0.8), inset -1px -1px 2px rgba(184,171,155,0.3)',

                        'hyper-pressed': 'inset 4px 6px 10px rgba(184,171,155,0.6), inset -4px -6px 10px rgba(255,255,255,0.7)',

                        'hyper-button': '0px 8px 15px rgba(28,35,49,0.3), inset 0px 1px 1px rgba(255,255,255,0.3), inset 0px -2px 3px rgba(0,0,0,0.4)',

                        'tray-deep': 'inset 10px 10px 20px rgba(184,171,155,0.5), inset -10px -10px 20px rgba(255,255,255,0.5)',

                        'gold-rim': '0 0 0 1px rgba(212,175,55,0.3), inset 0 0 0 1px rgba(255,255,255,0.2)',
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const datStr = `${tod.getFullYear()}-${String(tod.getMonth()+1).padStart(2,'0')}-${String(tod.getDate()).padStart(2,'0')}`;

            const dtInput = document.getElementById('bDat');

            if(dtInput) dtInput.value = datStr;
        ...
        function adicionaçãoRascunho() {

            const datVal = document.getElementById('bDat').value;
            ...
            if(!datVal) { alert("Por favor, selecione a dat."); return; }

            if(!assunto.trim()) { alert("Por favor, digite o conteúdo/assunto."); return; }



            const dObj = new Date(datVal + "T12:00:00");
            ...
            if(draftSemana.length > 0) {
                ...
                container.innerHTML = draftSemana.map(task => `
                    ...
                    <div class="p-4 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-between draft-slide-in shadow-sm">
                        ...
                        <div class="overflow-hidden">
                            ...
                            <p class="text-xs text-slate-400 font-medium mt-1 px-1"><span class="material-symbols-outlined text-[12px] align-middle mr-1">calendar_today</span>${task.dat.split('-').reverse().join('/')}</p>
                ...
                container.innerHTML = `
                    ...
                    <div class="m-auto text-center opacity-50 flex flex-col items-center">
                        ...
                        <p class="text-xs text-slate-400 max-w-[200px] mt-1">Selecione umédia e crie tarefas para preencher este mural.</p>
        ...
        function publicarPlanejamento() {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    window.locaton.href = 'mentoria.html';
        ...
        const mapAssuntos = {
            ...
            "FÍSICA": [
                ...
                "LEIS DE MAXWELL & ONDAS ELETROMAGNÉTICAS", "LEIS GERAIS DAS MUDANÇAS DE ESTADOS FÍSICOS DA MatRIA", 

                "LENTES ESFÉRICAS E AS CONDIÇÕES DE GAUSS", "MAGNETOSTÁTICA", "MÁQUINAS MECÊNICAS SIMPLES", "MOVIMENTO CIRCULAR UNIFORME (MCU)", 
                ...
                "SEGUNDA LEI DA TERMODINÂMICA & MÁQUINAS TÉRMICAS", "TEORIA DA RELATIVIDADE RESTRITA (1905)", "TEORIA DAS COLISÕES MECÊNICAS", 
            ...
            "QUÍMICA": [
                ...
                "TRANSFORMAÇÃO E PROPRIEDADES DA MatRIA"
        ...
        function renderMathropdown() {

            const mathptions = document.getElementById('bDisciplinaOptions');

            mathptions.innerHTML = '';
            ...
            mathrias.forEach(m => {
                ...
                div.onclick = () => {
                    ...
                    document.getElementById('bDisciplinaçãopdown').classList.add('hidden');
        ...
        function toggleMathropdown(e) {

            e.stopPropagationionion();

            const dropdown = document.getElementById('bDisciplinaçãopdown');
        ...
        function toggleAssDropdown(e) {
            ...
            if(!document.getElementById('bDisciplina').value) {
                ...
                alert("Selecione a mathria primeiro.");
        ...
        function carregarAssuntos(math {
            ...
            if (math&& mapAssuntos[math) {

                mapAssuntos[math.forEach(ass => {
            ...
            const divOutros = document.creatElement('div');
        ...
        document.addEventListener('click', (e) => {
            ...
            if(!e.target.closest('#bDisciplinaTrigger') && !e.target.closest('#bDisciplinaçãopdown')) {
