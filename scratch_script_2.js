...
function renderGabNovoEditor() {
    document.querySelectorAll('#gabNovo-qCount').forEach(el => el.innerText = gabNovoData.length);
...
function gabNovoImportarTexto() {
    ...
    gabNovoQuestoes = [];
    document.querySelectorAll('#gabNovo-questionsList').forEach(el => el.innerHTML = '');
    document.querySelectorAll('#gabNovo-qCount').forEach(el => el.innerText = '0');
    document.querySelectorAll('#gabNovo-pdfContent').forEach(el => el.innerHTML = '');
